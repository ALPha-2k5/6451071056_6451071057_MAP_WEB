...
final c = entry.value;
return DataRow(
// Hiệu ứng rê chuột (Hover) mặc định của
Flutter DataTable
...
c.updatedAt != null
?
"${c.updatedAt!.day.toString().padLeft(2,
'0')}/${c.updatedAt!.month.toString().padLeft(2, '0')}/${c.updatedAt!.year}"
: "-",
),
),
DataCell(
...
? Colors.indigoAccent
: Colors.white,
foregroundColor: isSelected ? Colors.white :
Colors.black87,
...
await
context.read<CategoryController>().update(newCategory);
}
Navigator.pop(context);
},
child: const Text(
