...
import 'package:thuchanhweb/controllers/product_review_controller.dart';
...
class AllReviewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        backgroundColor: const Color(0xFFF8F9FA), // Modern light gray background
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Quản lý và duyệt phản hồi sản phẩm",
                            style: TextStyle(
                              fontSize: 14,
                      ...
                      Container(
                        ...
                        child: Text(
                          "Tổng: ${controller.filteredReviews.length}",
                        ...
                        Expanded(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText:
                                  "Tìm theo sản phẩm, khách hàng hoặc nội dung...",
  ...
  /// Widget shown when no data is found
  ...
  Future<void> _showDeleteDialog(
    ...
    final bool? confirm = await showDialog<bool>(
      ...
      builder: (BuildContext context) => AlertDialog(
        ...
        content: const Text(
          "Hành động này không thể hoàn tác. Bạn có muốn xóa đánh giá vĩnh viễn không?",
        ),
        actions: [
          TextButton(
